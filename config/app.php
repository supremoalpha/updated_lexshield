...
if (!function_exists('lex_uri_folder_prefix')) {
    ...
    function lex_uri_folder_prefix(string $uri): string
    {
        ...
        $rootFiles = 'index|portal|go|open|chat|chat_call|chat_call_signal|chat_call_ring|chat_typing|notifications_api|lexshield|setup|client|lawyer|admin|attorney|fix_mail|case_files|case_document_file|case_file_attachment|message_attachment|message_view|payment_proof|payment_qr_image|video_call_signal';
