...
lex_hh_assert('FAQ questions each sit in their own box', str_contains($home, 'id="faq"') && str_contains($home, 'pao-faq-list') && substr_count($home, 'pao-faq-item') === 3 && str_contains($home, 'Walk-in or online?'));
...
lex_hh_assert('FAQ title sits tight on the question boxes', str_contains($style, 'body.pao-home .pao-faq > h2') && str_contains($style, 'body.pao-home .pao-faq-list'));
