...
lex_mvf_assert('Thread shows View before Download', str_contains($shared, 'inbox-media-download') && str_contains($shared, 'lex_messages_view_url'));
lex_mvf_assert('Pictures and videos use a Messenger download icon', str_contains($shared, 'inbox-media--image') && str_contains($shared, 'inbox-media--video') && str_contains($shared, 'inbox-file'));
