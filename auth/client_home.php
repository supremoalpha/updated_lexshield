...
$assignedLawyer = lex_recent(
    'SELECT u.full_name, u.email, u.avatar_stored_name
     FROM cases c
    ...
    <article class="client-dashboard-next card">
      ...
      <?php if ($nextAppointment): ?>
        ...
        <div class="client-dashboard-next-actions">
          ...
          <a class="button button-secondary" href="<?= lex_e(lex_nav_href('chat.php')) ?>">Message lawyer</a>
          <a class="button button-secondary" href="<?= lex_e(lex_nav_href('case_files.php')) ?>">My Documents</a>
        </div>
      <?php else: ?>
