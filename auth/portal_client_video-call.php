...
if (!$appointment) {
    ...
    <section class="card video-call-card video-call-card--empty">
      ...
      <a class="button button-primary" href="<?= lex_e(lex_app_url('client/appointment.php')) ?>">Back to appointments</a>
    </section>
    <?php
    ...
    <section class="card video-call-card video-call-card--empty">
      ...
      <p class="muted">Video calls open once your lawyer confirms the appointment. Current status: <strong><?= lex_e((string) $appointment['status']) ?></strong>.</p>
      <a class="button button-primary" href="<?= lex_e(lex_app_url('client/appointment.php')) ?>">Back to appointments</a>
    </section>
    <?php
} else {
    ...
    lex_video_call_render_room($appointment, $session, 'client', (string) ($user['full_name'] ?? 'Client'));
}
